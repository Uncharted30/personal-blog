    ...
    export default {
        ...
        methods: {
            getLogList() {
                ...
                this.$axios.get('api/admin/operationLog/' + this.pageSize + '/' + this.pageNumber, {
                    params: params,
                }).then(response => {
                    if (response.data.code === 200) {
                        ...
                        this.$message.error("Failed getting operation logs, please try again later. " + response.data.message);
                    }
                }).catch(e => {
                    this.$message.error("Failed getting operation logs, please try again later. " + e);
                });
            },
            handleDelete(index, row) {
                this.$axios.delete("api/admin/operationLog/" + row.id).then(response => {
                    if (response.data.code === 200) {
